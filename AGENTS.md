# Hisabati: Kitabu cha Mwanafunzi Darasa la Nne — ADT Bundle Reference
...
**Hisabati: Kitabu cha Mwanafunzi Darasa la Nne** — Kitabu hiki ni cha Hisabati kwa mwanafunzi wa Darasa la Nne wa shule ya msingi nchini Tanzania, kimeandaliwa na Taasisi ya Elimu Tanzania na kimeandikwa kwa Kiswahili. Kinafundisha mada za msingi za hesabu kama namba za Kirumi, kuzidisha na kugawanya namba nzima, vipimo, mzingo na eneo, sehemu, desimali, muda, na fedha ya Tanzania. Kimekusudiwa wanafunzi wa kiwango cha elimu ya msingi wa kati, na kinatumia mbinu ya ufundishaji inayosisitiza mifano, mazoezi, kazi za vitendo, michoro na matumizi ya hisabati katika maisha ya kila siku.
...
├── HISABATI-DRS-4-PB--SEPT-2025-.db                    # SQLite database (pipeline state)
├── HISABATI-DRS-4-PB--SEPT-2025-.pdf                   # Original source PDF
...
```json
{
  ...
  "pg001_im001": "",
  "gl001": "alama <",
  "gl001_def": "Alama inayoonyesha kuwa namba ya kushoto ni ndogo kuliko ya kulia."
}
```
...
```json
{
  "alama <": {
    "word": "alama <",
    "definition": "Alama inayoonyesha kuwa namba ya kushoto ni ndogo kuliko ya kulia.",
    "variations": ["alama <"],
    "emoji": "⬅️🔽"
  }
}
...
| Original PDF | `HISABATI-DRS-4-PB--SEPT-2025-.pdf` |
| Pipeline database | `HISABATI-DRS-4-PB--SEPT-2025-.db` (SQLite) |
